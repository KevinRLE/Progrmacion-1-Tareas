    ...
    //implementacion de atributos y metodos
    Config::Config(int filasTablero, int columnasTablero, int minasTablero, bool modoDesarrolladorTablero, int vidasTablero)    //encabezado clase
    {
    ...
    void Config::menuConfiguracion()
    {
        ...
        do
        {
            ...
            cout << "\t\t-------------------"<< endl;
            cout << "\t\t1. Filas del Tablero ----> " << this->getfilasTablero() << endl;   //"this->"apunta al atributo del objeto que estoy utilizando para saber cual voy a usar, sino c se puede confundir
    ...
    //Se puede hacer validaciones en get y set (mejor)
