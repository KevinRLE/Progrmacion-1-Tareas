//Modificacion de programa para encontrar promedios de las carreras
...
void llamaCiclo()
{
    ...
    do
    {
        ...
        //Solo se agregaron impresiones de mensajes donde se ve el promedio de la carrera
        //ya que el procedimiento estaba pero no se mostraba
...
float imprimirMatriz(float matriz[NUMERO_ALUMNOS][NUMERO_NOTAS + 1], char alumnos[NUMERO_ALUMNOS][MAXIMA_LONGITUD_CADENA], string nombreFacultad)
{
    ...
    cout << "Nota prom : " << setw(20) <<  promedioGeneral << endl << endl;
